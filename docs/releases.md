...
Download the latest version from the repository's [GitHub Releases](https://github.com/koinunopochi/asana-cli-for-agents/releases)
page.
...
Every archive contains the `asana` executable, `LICENSE`, `NOTICE`, `README.md`,
and detailed `docs/`. Use the `SHA256SUMS` asset to verify the download.
...
archives and `SHA256SUMS`, and creates or updates the GitHub Release.

If `docs/releases/<tag>.md` exists, its contents are used as the release notes;
otherwise GitHub generates release notes automatically.
